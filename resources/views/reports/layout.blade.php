...
window.addEventListener('DOMContentLoaded', event => {
    ...
    <div class="container">
        ...
        {{-- this one is the hell that 
        you have to respect 
        you haves to know how should be behaving while you are invited as a guest
        you don have to impress while doing this but, you are giving the real respect 
        for them , and avoid some negativitits that might coming to you <div class="">
            good job,
        </div>
        you do not haves to be limited to the peoples that you respect 
        and you know what peoples have also their own 
        interest 
        view 
        you do not haves to be prepared in the way that it brings some 
        but it is better if your dopamine level is way 100%
        be cool
        ans also smart 
        okay that is what helps human to be human 
        sometimes touch the untouchble 
